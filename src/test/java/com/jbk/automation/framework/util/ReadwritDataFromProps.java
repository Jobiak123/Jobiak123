...
public class ReadwritDataFromProps {
	...
	static{
		try{
		FileInputStream fs = new FileInputStream(System.getProperty("user.dir")+"\\src\\test\\resources\\prod.properties");
	...
	public static void writeDyanamicData(String key,String value) {
		...
		try {
			...
			output = new FileOutputStream(System.getProperty("user.dir")+"\\src\\test\\resources\\prod.properties");
